...
export function About() {
  return <main className="about-page">
    <header className="about-nav"><Link className="about-logo" to="/"><span>LANDSLIDE</span><b>GUARD</b></Link><nav><Link to="/">Overview</Link><Link className="active" to="/about">About the project</Link><Link to="/dashboard/console">Open console <ArrowUpRight size={15} /></Link></nav></header>
